...
class OrderGoods(BaseModel):
    ...
    # 一对多关联属性
    order = models.ForeignKey(to=OrderInfo, related_name='skus',
                              on_delete=models.CASCADE, verbose_name='订单')

    sku = models.ForeignKey(to=SKU, on_delete=models.PROTECT, verbose_name='订单商品')

    count = models.IntegerField(default=1, verbose_name='数量')

    price = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='单价')

    comments = models.TextField(default='', verbose_name='评价信息')

    score = models.IntegerField(default=5, verbose_name='满意度评分')
